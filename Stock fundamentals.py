...
num_stocks = int(input('Number of stocks for optimization analysis:'))
...
print(' For portfolio optimization it is necessary for the data to be in the same timeframe. So beware of IPOs ')
...
num_of_data = int(input('Number of stock for download:'))
...
if num_of_data == 0:
    ...
    for ticker in tickers: 
        ...
        df11 = ticker.earnings_history
        if len(df11.value_counts()) > 0 :
            file_name11 = input('File of dividends name (ex: financials_tsla.csv:)')
            df5.to_csv(info_store+str(file_name11)) 
        else:
            print("No information available") 

        print('Options',ticker.options)
        df12 = ticker.options
        file_name12 = input('File of options name (ex: financials.csv:)')
        df12.to_csv(info_store+str(file_name12)) 

        print('Institutional holders',ticker.institutional_holders)
        df13 = ticker.institutional_holders
        file_name13 = input('File of institutional holders name (ex: financials_tsla.csv):')
        df13.to_csv(info_store+str(file_name13))
